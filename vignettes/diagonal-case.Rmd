...
capture-probabilities are (mostly) homogeneous at each wheel in each week. Furthermore, suppsoe that
...
Petersen estimate for julian week 41. Similrly, the vector $bad.u2$ indicates in which julian weeks, the number of unmarked fish is suspect.
