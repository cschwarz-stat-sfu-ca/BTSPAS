...
for external events.
* sometimes bad thing happend.  The vector $bad.m2$ indicates which julian weeks something went wrong. 
...
Similrly, the vector $bad.u2$ indicates which julian weeks, the number of unmarked fish is suspect.
