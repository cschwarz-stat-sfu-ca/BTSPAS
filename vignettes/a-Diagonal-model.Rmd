...
relationship between *logit(catcability)* and covariates.
...
Here is an example of some (ficticious) raw data that includes the covariate $log(flow)$: 
...
now believes that the variation around the line must be lare, which allows 
